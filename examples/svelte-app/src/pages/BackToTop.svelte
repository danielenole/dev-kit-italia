...
<section style="height: 2000px; background: linear-gradient(white, lightgray); margin-top: 20px;">
  ...
  <p class="small">
    Il componente è stato inserito nel file App.svelte per fare in modo che la sua posizione nel DOM sia dopo il footer.
    In questo modo è anche presente in tutte le pagine dell'applicazione di esempio.
  </p>
</section>
