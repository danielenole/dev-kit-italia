...
Per personalizzare gli stili, puoi usare il selettori `::part` passando il valore `avatar`. [Vai alla guida sui selettori part](/docs/personalizzazione-degli-stili--documentazione#selettore-part).
