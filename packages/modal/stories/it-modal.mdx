...
Nella tabella trovi gli per personalizzare l'aspetto e il comportamento del componente. Data la complessità, l'anteprima non verrà aggiornata in tempo reale al variare degli attributi. 
...
Per la creazione di una modale usa il componente `<it-modal>` e inserisci al suo interno contenuto desiderato, intestazione ed eventuali azioni.
