...
Tutti gli esempi forniscono un'implementazione di base per la chiusura della modale, analoga alla seguente, attraverso event listener sul click del pulsante:
