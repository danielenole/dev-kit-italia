...
## Cosa fa
Il componente Autocompletamento consiste in un campo input con funzione di autocompletamento dei dati che fornisce all'utente suggerimenti pertinenti mentre inizia a digitare.
...
[Approfondisci quando e come usare il componente Autocompletamento](https://designers.italia.it/design-system/form/autocompletamento/)
...
Espandi il codice dell'esempio sottostante per vedere un esempio di come implementare questa funzionalità.
