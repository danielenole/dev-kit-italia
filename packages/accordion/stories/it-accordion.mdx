...
Per applicare lo sfondo primario agli header attivi, imposta l'attributo `background-active` sull'elemento `it-accordion`.
...
Per applicare sfondo primario agli header al passaggio del mouse, imposta l'attributo `background-hover` sull'elemento `it-accordion`.
