import{b as s}from"./iframe-CabDQJiJ.js";const a=s`
...
</footer>`,o={title:"Componenti/Footer",component:"footer",tags:["documentation"]},i={tags:["!autodocs","!dev"],parameters:{canvas:{hidden:!0,sourceState:"none"},viewMode:"docs",docs:{page:null}}},e={render:()=>s`${a}`,name:"Footer completo",parameters:{docs:{description:{story:`Nel footer completo sono presenti i seguenti elementi:
