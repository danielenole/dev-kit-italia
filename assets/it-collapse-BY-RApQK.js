import{j as e,M as s,C as l,a}from"./blocks-48TzfsRj.js";import{useMDXComponents as t}from"./index-Ca1LlF4u.js";import{C as d,E as o,a as c,A as p,L as h,T as u,b as g}from"./it-collapse.stories-D4XFBQ5y.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-D-IYe-vP.js";import"./reusableUsageGuidelinesStories-CuC1mvt0.js";import"./form-control-B0fnRwPb.js";function r(n){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:d}),`
...
`,e.jsxs(i.p,{children:[e.jsx(i.a,{href:"https://designers.italia.it/design-system/componenti/collapse/",rel:"nofollow",children:"Approfondisci quando e come usare il componente Collapse"}),"."]}),`
...
`,e.jsxs(i.p,{children:["Il componente ",e.jsx(i.code,{children:"it-collapse"})," utilizza diversi slot per definire il trigger, il testo mostrato nel trigger e il contenuto collassabile:"]}),`
`,e.jsxs(i.ul,{children:[`
...
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:"::part(content)"})," - elemento contenitore del corpo collassabile"]}),`
`]}),`
