import{x as i}from"./iframe-Bva7CR0T.js";import{o as l}from"./query-CblQfenQ.js";import"./it-button-C63sGHtk.js";import"./it-icon-D64LtsYF.js";import"./preload-helper-Dp1pzeXC.js";import"./directive-CvdRHFdJ.js";const G=["lg","sm","xs"],M=["primary","secondary","success","danger","warning","link"],t=(e,n="")=>{var s;const a=((s=e.slot)==null?void 0:s.length)>0?e.slot:n;return i`
    <it-button
      variant="${l(e.variant)}"
      ?outline="${e.outline}"
      size="${l(e.size)}"
