import{j as e,M as c,C as n,a}from"./blocks-48TzfsRj.js";import{useMDXComponents as r}from"./index-Ca1LlF4u.js";import{A as d,E as l,a as t,S as p,H as h,b as m,I as u,c as x}from"./it-accordion.stories-B4uVU1rs.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-D-IYe-vP.js";import"./reusableUsageGuidelinesStories-CuC1mvt0.js";import"./form-control-B0fnRwPb.js";function s(o){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{of:d}),`
...
`,e.jsxs(i.p,{children:[e.jsx(i.a,{href:"https://designers.italia.it/design-system/componenti/accordion/",rel:"nofollow",children:"Approfondisci quando e come usare il componente Accordion"}),"."]}),`
...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:"it-accordion"}),": contenitore che raggruppa più elementi collassabili"]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:"it-accordion-item"}),": singolo elemento collassabile all'interno dell'accordion"]}),`
`]}),`
`,e.jsx(i.h2,{id:"accordion-item",children:"Accordion item"}),`
`,e.jsxs(i.p,{children:[e.jsx(i.code,{children:"it-accordion-item"})," rappresenta il singolo elemento collassabile all'interno dell'accordion."]}),`
...
`]}),`
`,e.jsxs(i.p,{children:[e.jsx(i.a,{href:"/docs/personalizzazione-degli-stili--documentazione#selettore-part",children:"Vedi qui la guida dettagliata"}),"."]})]})}function I(o={}){const{wrapper:i}={...r(),...o.components};return i?e.jsx(i,{...o,children:e.jsx(s,{...o})}):s(o)}export{I as default};
