import{x as a}from"./iframe-B8IU2_pc.js";const l=({otherProps:i="",otherMethods:o="",otherEvents:t="",componentName:e="it-input"})=>({name:"Proprietà, Metodi, ed Eventi accessibili via js",tags:["!dev"],render:()=>a`<div class="hide-preview"></div>`,parameters:{viewMode:"docs",docs:{description:{story:`
