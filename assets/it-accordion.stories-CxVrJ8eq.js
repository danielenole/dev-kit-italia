import{x as i,o as q}from"./iframe-C4eBJZ64.js";import"./preload-helper-Dp1pzeXC.js";const C=["single","multiple"],O=e=>i`
...
`,p=[{label:"Accordion Item #1",content:"Vestibulum hendrerit ultrices nibh, sed pharetra lacus ultrices eget. Morbi et ipsum et sapien dapibus facilisis. Integer eget semper nibh. Proin enim nulla, egestas ac rutrum eget, ullamcorper nec turpis.",defaultOpen:!0},{label:"Accordion Item #2",content:"Vestibulum hendrerit ultrices nibh, sed pharetra lacus ultrices eget. Morbi et ipsum et sapien dapibus facilisis. Integer eget semper nibh. Proin enim nulla, egestas ac rutrum eget, ullamcorper nec turpis."},{label:"Accordion Item #3",content:"Vestibulum hendrerit ultrices nibh, sed pharetra lacus ultrices eget. Morbi et ipsum et sapien dapibus facilisis. Integer eget semper nibh. Proin enim nulla, egestas ac rutrum eget, ullamcorper nec turpis."}],Q={title:"Componenti/Accordion",tags:["autodocs","a11y-ok","web-component"],component:"it-accordion",args:{mode:"multiple",backgroundActive:!1,backgroundHover:!1,leftIcon:!1},decorators:[(e,t)=>{var n;return((n=t==null?void 0:t.parameters)==null?void 0:n.useMetaDecorator)===!1?e():i`<div style="min-height:350px;display:flex;align-items:center">${e()}</div>`}],argTypes:{mode:{control:"select",description:"Se impostato a `single`, solo un elemento dell'accordion può essere aperto contemporaneamente. Il default è `multiple`.",table:{defaultValue:{summary:"multiple"}},options:C},backgroundActive:{control:"boolean",description:"Applica sfondo primario agli header attivi (quando il contenuto è visibile)",table:{defaultValue:{summary:"false"}},name:"background-active"},backgroundHover:{control:"boolean",description:"Applica sfondo primario agli header al passaggio del mouse",table:{defaultValue:{summary:"false"}},name:"background-hover"},leftIcon:{control:"boolean",description:"Mostra icone plus/minus a sinistra invece della freccia a destra (Bootstrap Italia)",table:{defaultValue:{summary:"false"}},name:"left-icon"}},parameters:{layout:"padded",docs:{source:{excludeDecorators:!0},description:{component:`
...
\`
  ...
  render: args => renderComponent(args, defaultItems)
}`,...(D=(T=d.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};const R=["EsempioInterattivo","AccordionItem","Single","AccordionAnnidati","HeaderAttivi","HoverDegliHeader","IconaASinistra"];export{s as AccordionAnnidati,o as AccordionItem,a as EsempioInterattivo,c as HeaderAttivi,l as HoverDegliHeader,d as IconaASinistra,r as Single,R as __namedExportsOrder,Q as default};
