import{x as t,o as $}from"./iframe-D3QJi_qI.js";const q=["lg","sm","xs"],M=["primary","secondary","success","danger","warning","link"],a=(n,e="")=>{var o;const i=((o=n.slot)==null?void 0:o.length)>0?n.slot:e;return t`
    <it-button
      variant="${$(n.variant)}"
      ?outline="${n.outline}"
      size="${$(n.size)}"
