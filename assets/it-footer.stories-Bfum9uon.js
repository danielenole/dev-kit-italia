import{x as a}from"./iframe-BiclfI91.js";import"./it-icon-CSHPhcQf.js";import"./it-button-7O2qlVVR.js";import"./it-input-CzYBhIdL.js";import"./preload-helper-Dp1pzeXC.js";import"./query-Bd2ew8Gc.js";import"./directive-CvdRHFdJ.js";import"./if-defined-tWK9HKZq.js";import"./query-assigned-elements-DeyBePrH.js";import"./when-BR7zwNJC.js";import"./live-DG_rsUJd.js";const h=a`
...
</footer>`,I={title:"Componenti/Footer",component:"footer",tags:["autodocs"],parameters:{docs:{description:{component:`<Description>Documentazione ed esempi per la creazione di piè di pagina di navigazione.</Description>
...
**In caso non si stia utilizzando il bundle unico, assicurarsi di avere importato tutti i fogli di stile necessari da \`bootstrap-italia\`.**
        `.trim()}}}},i={tags:["!autodocs","!dev"],parameters:{canvas:{hidden:!0,sourceState:"none"},viewMode:"docs",docs:{page:null}}},e={render:()=>a`${h}`,name:"Footer completo",parameters:{docs:{description:{story:`Nel footer completo sono presenti i seguenti elementi:
...
- **Iscrizione Newsletter** (opzionale).`}}}},l={render:()=>a`${f}`,name:"Footer compatto",parameters:{docs:{description:{story:`Il footer compatto è una versione semplificata del footer completo.
...
`}}}};var t,s,o;i.parameters={...i.parameters,docs:{...(t=i.parameters)==null?void 0:t.docs,source:{originalSource:`{
  tags: ['!autodocs', '!dev'],
  parameters: {
    canvas: {
      hidden: true,
...
}`,...(o=(s=i.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};var n,r,c;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
...
}`,...(c=(r=e.parameters)==null?void 0:r.docs)==null?void 0:c.source}}};var d,m,p;l.parameters={...l.parameters,docs:{...(d=l.parameters)==null?void 0:d.docs,source:{originalSource:`{
...
}`,...(p=(m=l.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};const D=["Placeholder","FooterCompleto","FooterCompatto"];export{l as FooterCompatto,e as FooterCompleto,i as Placeholder,D as __namedExportsOrder,I as default};
