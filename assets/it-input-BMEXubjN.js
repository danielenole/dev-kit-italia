...
.password-icon {
  ...
  --bs-icon-default: var(--bs-icon-primary);
      ...
      `:_}_renderSuggestions(){return this.suggestions?u`<div class="strength-meter-suggestions small form-text text-muted">
          <label class="visually-hidden" for="suggestions">${this.$t("passwordSuggestionsLabel")}</label>
          <div class="password-suggestions">
            ${V.map(t=>{const e=t.test(this.value,this._getPasswordConfig());return u`
        ...
        </div>`:_}_renderpasswordStrengthMeter(){var t;if(this.type==="password"&&this.passwordStrengthMeter){const e=this._score<0?0:this._score,o=((t=this.value)==null?void 0:t.length)===0?"muted":nt(this._score);return u`<div class="password-strength-meter">
      ...
      `}return l}render(){var l;const t=`${this._id}-support-text`,e=u` ${y(this.supportText,()=>u` <small class="form-text" id="${t}">${this.supportText}</small> `)}`,o=this.validationMessage??"",i=(o==null?void 0:o.length)>0||!this.customValidation&&((l=this.inputElement)==null?void 0:l.checkValidity())===!1,a=u`<div
      role="alert"
    ...
    >
      ...
      <div class="form-group" part="input-wrapper">
        ...
        ${y(this.slotted||this.type==="number",()=>u`<div
              ...
              >
                ${y(this._slotPrepend,()=>u` <span class="input-group-text">
                      <slot name="prepend" @slotchange=${()=>this.requestUpdate()}></slot
                    ></span>`)}
                ${this._renderInput(t,i,o)}
                ${y(this.type==="number",()=>u`<span class="input-group-text align-buttons flex-column">
                      <button
                ...
                ${y(this._slotAppend,()=>u` <div class="input-group-append">
