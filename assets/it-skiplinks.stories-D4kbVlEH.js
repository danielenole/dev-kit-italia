...
`}}}},a={...n,name:"Esempio",args:{"it-aria-label":"Vai a:"},parameters:{docs:{className:"my-wide-story",canvas:{sourceState:"shown"}}},render:e=>t` ${m({...e,slot:t`<a href="#menu">Vai al menu</a>
