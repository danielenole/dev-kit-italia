import{o as i,E as s,x as a}from"./iframe-CPtuQipa.js";const le=["xs","sm","md","lg","xl","xxl"],pe=["primary","secondary"],ce=["image","text","icon"],de=["active","busy","hidden"],me=["approved","declined","notify"],e=t=>a`
  <it-avatar
    type="${i(t.type||s)}"
    size="${i(t.size||s)}"
...
\`
  ...
  \`
}`,...(O=(I=m.parameters)==null?void 0:I.docs)==null?void 0:O.source}}};var _,q,F;v.parameters={...v.parameters,docs:{...(_=v.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
\`
  ...
  \`
}`,...(F=(q=v.parameters)==null?void 0:q.docs)==null?void 0:F.source}}};var Q,J,K;u.parameters={...u.parameters,docs:{...(Q=u.parameters)==null?void 0:Q.docs,source:{originalSource:`{
