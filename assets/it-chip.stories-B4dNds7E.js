...
`,_t=s=>{const{avatar:t,avatarAlt:e,withIcon:i,label:a,size:r,variant:l,withDismissButton:m,dismissable:y,isDisabled:z,href:wt,id:Et,a11yDescription:Ct}=s;return d`
    <it-chip
      label="${a??""}"
      size="${r??"sm"}"
      variant="${l??""}"
