...
`}}}},o={...n,name:"Esempio interattivo",tags:["!autodocs","!dev"],parameters:{docs:{canvas:{sourceState:"shown"}}},render:e=>i`${t({...e,type:"text",label:"Campo di testo",name:"testo",id:"exampleInputText"})}
  ...
  `},p={...n,parameters:{docs:{description:{story:"L'input di base ha una dimensione media che non necessita di alcuna classe aggiuntiva.\n\nPer modificare questa dimensione, è possiible utilizzare l'attributo `size` il cui valore può essere `sm` oppure `lg`.\n\nPer modificare invece la dimensione dell’icona, è possibile utilizzare l'attributo `size` sull'icona in questo modo:\n<table>\n<thead>\n  <tr><th>Dimensione input</th><th>Attributo size (di it-input)</th><th>Dimensione icona</th></tr>\n</thead>\n<tbody>\n  <tr><td>Grande</td><td>`lg`</td><td>`md`</td></tr>\n  <tr><td>Base (default)</td><td></td><td>`sm`</td></tr>\n  <tr><td>Piccola</td><td>`sm`</td><td>`xs`</td></tr>\n</tbody>\n</table>\n"}}},args:{type:"text",placeholder:"Testo segnaposto"},render:e=>i`
    ...
    ${t({...e,label:"Campo di dimensione piccola",name:"field-small-example",id:"field-small-example",size:"sm",children:i`<it-icon name="it-pencil" slot="prepend" size="xs"></it-icon>
        <it-button variant="primary" slot="append">Invio</it-button>`})}
  `},m={...n,name:"Stato disabilitato",parameters:{docs:{description:{story:"Aggiungi l’attributo `disabled` ad un `<it-input>` per impedire la modifica del valore contenuto e non inviare i dati in esso contenuti."}}},args:{type:"text",label:"Campo disabilitato",name:"field-disabled-example",id:"field-disabled-example",disabled:!0},render:e=>i`
    ${t({...e})}
  `},c={...n,name:"Stato readonly",parameters:{docs:{description:{story:"Aggiungi l’attributo `readonly` ad un `<it-input>` per impedire la modifica del valore contenuto.\n<br/><br/><h4>Readonly normalizzato</h4>Se per qualche motivo vuoi avere gli elementi input readonly nella forma stilizzata come testo, aggiungi l'attributo `plaintext` a `<it-input>`."}}},args:{type:"text",readonly:!0,value:"Contenuto in sola lettura"},render:e=>i`
...
}`,...(w=($=o.parameters)==null?void 0:$.docs)==null?void 0:w.source}}};var S,C,I;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  ...meta,
...
\`
  ...
  \`
}`,...(I=(C=r.parameters)==null?void 0:C.docs)==null?void 0:I.source}}};var q,P,T;s.parameters={...s.parameters,docs:{...(q=s.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...meta,
...
<br/><br/><h4>Readonly normalizzato</h4>Se per qualche motivo vuoi avere gli elementi input readonly nella forma stilizzata come testo, aggiungi l'attributo \\\`plaintext\\\` a \\\`<it-input>\\\`.\`
  ...
  \`
}`,...(F=(U=c.parameters)==null?void 0:U.docs)==null?void 0:F.source}}};var Q,k,B;u.parameters={...u.parameters,docs:{...(Q=u.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  ...meta,
  parameters: {
    docs: {
      description: {
...
\`
  ...
  \`
}`,...(B=(k=u.parameters)==null?void 0:k.docs)==null?void 0:B.source}}};var J,Y,Z;g.parameters={...g.parameters,docs:{...(J=g.parameters)==null?void 0:J.docs,source:{originalSource:`{
  ...meta,
  name: 'Area di testo',
  parameters: {
    docs: {
...
}`,...(le=(se=z.parameters)==null?void 0:se.docs)==null?void 0:le.source}}};const ye=["EsempioInterattivo","Placeholder","TestoDiSupporto","LabelHidden","IconeOPulsanti","Dimensioni","Disabilitato","Readonly","Password","Textarea","GestioneErrori","GestioneEventi","MetodiEPropPubblici","I18n"];export{p as Dimensioni,m as Disabilitato,o as EsempioInterattivo,v as GestioneErrori,b as GestioneEventi,z as I18n,d as IconeOPulsanti,l as LabelHidden,h as MetodiEPropPubblici,u as Password,r as Placeholder,c as Readonly,s as TestoDiSupporto,g as Textarea,ye as __namedExportsOrder,n as default};
