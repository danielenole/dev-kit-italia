import{b as a,o as i,A as s}from"./iframe-Chq22p9w.js";const f=["xs","sm","md","lg","xl","xxl"],b=["primary","secondary"],R=["image","text","icon"],M=["active","busy","hidden"],T=["approved","declined","notify"],e=t=>a`
  <it-avatar
    type="${i(t.type||s)}"
    size="${i(t.size||s)}"
