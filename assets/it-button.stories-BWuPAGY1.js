import{b as t,o as v}from"./iframe-CabDQJiJ.js";const y=["lg","sm","xs"],k=["primary","secondary","success","danger","warning","link"],a=(n,e="")=>{const m=n.slot?.length>0?n.slot:e;return t`
    <it-button
      variant="${v(n.variant)}"
      ?outline="${n.outline}"
      size="${v(n.size)}"
