import{x as a}from"./iframe-D-IYe-vP.js";import"./preload-helper-Dp1pzeXC.js";const v=a`
...
</footer>`,g={title:"Componenti/Footer",component:"footer",tags:["autodocs","documentation"],parameters:{docs:{description:{component:`<Description>Menu di navigazione secondaria posto in fondo alle pagine per presentare contenuti supplementari come contatti, informazioni legali e link alle sezioni di un sito</Description>
...
**Se non usi il pacchetto completo di Bootstrap Italia (bundle), ricordati di importare tutti i CSS.**
        `.trim()}}}},i={tags:["!autodocs","!dev"],parameters:{canvas:{hidden:!0,sourceState:"none"},viewMode:"docs",docs:{page:null}}},e={render:()=>a`${v}`,name:"Footer completo",parameters:{docs:{description:{story:`Nel footer completo sono presenti i seguenti elementi:
...
}`,...(o=(t=i.parameters)==null?void 0:t.docs)==null?void 0:o.source}}};var n,r,c;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
...
}`,...(p=(m=l.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};const z=["Placeholder","FooterCompleto","FooterCompatto"];export{l as FooterCompatto,e as FooterCompleto,i as Placeholder,z as __namedExportsOrder,g as default};
