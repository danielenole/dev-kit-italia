import{o as e,E as l,x as _}from"./iframe--5LOoNCc.js";import"./preload-helper-Dp1pzeXC.js";function T({stackable:r,paddingTop:w,stickyClassName:M,positionType:I}){return _`
    <it-sticky
      ?stackable=${e(r)}
      padding-top=${e(w||l)}
  ...
  `}const O={title:"Componenti/Sticky",component:"it-sticky",tags:["autodocs","beta","a11y-ok","web-component"],args:{stackable:!1,paddingTop:0,stickyClassName:void 0,positionType:void 0},parameters:{docs:{description:{component:`<Description>Rende un elemento della pagina costantemente visibile allo scorrere della pagina.</Description>
