import{o as e,A as l,b as m}from"./iframe-Chq22p9w.js";import"./preload-helper-PPVm8Dsz.js";function u({stackable:r,paddingTop:c,stickyClassName:d,positionType:p}){return m`
    <it-sticky
      ?stackable=${e(r)}
      padding-top=${e(c||l)}
  ...
  `}const k={title:"Componenti/Sticky",component:"it-sticky",tags:["autodocs","beta","a11y-ok","web-component"],args:{stackable:!1,paddingTop:0,stickyClassName:void 0,positionType:void 0},parameters:{docs:{description:{component:`<Description>Rende un elemento della pagina costantemente visibile allo scorrere della pagina.</Description>
