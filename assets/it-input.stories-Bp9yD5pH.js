import{x as s,a as Oe}from"./iframe-CXDqws0b.js";import{r as qe,e as je,n as u,o as d}from"./query-Bgk1JvUp.js";import{I as Ne,a as _e}from"./types-krleEmxp.js";import"./it-icon-CLY6zOjc.js";import"./it-button-GG-ZkDmX.js";import"./it-input-C1OoXnSs.js";import"./preload-helper-Dp1pzeXC.js";import"./directive-CvdRHFdJ.js";import"./query-assigned-elements-kOdE9H1L.js";import"./when-BR7zwNJC.js";const Re=({otherProps:i="",otherMethods:e="",otherEvents:t="",componentName:n="it-input"})=>({name:"Proprietà, Metodi, ed Eventi accessibili via js",tags:["!dev"],render:()=>s`<div class="hide-preview"></div>`,parameters:{viewMode:"docs",docs:{description:{story:`Il componente espone delle proprietà, dei metodi e degli eventi, utili per eventuali interazioni via js.
...
`}}}},w={...h,name:"Esempio interattivo",tags:["!autodocs","!dev"],parameters:{docs:{canvas:{sourceState:"shown"}}},render:i=>s`${r({...i,type:"text",label:"Campo di testo",name:"testo",id:"exampleInputText"})}
  ...
  `},A={...h,name:"Gestione degli eventi",parameters:{docs:{description:{story:"E' possibile gestire gli eventi di `it-input`, `it-blur`, `it-change`, `it-focus`, `it-click` per effettuare operazioni personalizzate, come la validazione esterna o l'aggiornamento di altri campi.\n        <br/><br/>\n        È sufficiente aggiungere un event listener al componente `<it-input>` per intercettare gli eventi desiderati. Ad esempio, per gestire l'evento di input, è possibile utilizzare il seguente codice:\n\n```js\ndocument.querySelector('it-input#event-input-example').addEventListener('it-input', (event) => {\n  console.log('Input event:', event);\n  alert('Input event);\n});\n```\n\nIl componente, emette anche un evento di tipo `it-input-ready` quando l'input è pronto e caricato nel DOM:\n\n```js\ndocument.querySelector('it-input#event-input-example').addEventListener('it-input-ready', (event) => {\n  console.log('Input ready:', event);\n});\n```\n      "}}},args:{type:"text",label:"Prova evento di input",name:"event-input-example",id:"event-input-example",placeholder:"Testo segnaposto"},render:i=>s(R||(R=Ke([`
    ...
    <\/script>
    `,`
  `])),r({...i}))},L={...Re({}),tags:["!dev"]},F={name:"i18n",tags:["!dev"],render:()=>s`<div class="hide-preview"></div>`,parameters:{viewMode:"docs",docs:{description:{story:`
...
\`\`\`js
const translation = {
  ${JSON.stringify(Ye).replaceAll('{"','"').replaceAll('",',`",
	`).replaceAll('"}','"')}
}
\`\`\`
...
}`,...(B=(U=w.parameters)==null?void 0:U.docs)==null?void 0:B.source}}};var H,Q,G;C.parameters={...C.parameters,docs:{...(H=C.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...meta,
...
\`
  ...
  \`
}`,...(G=(Q=C.parameters)==null?void 0:Q.docs)==null?void 0:G.source}}};var W,J,Y;E.parameters={...E.parameters,docs:{...(W=E.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...meta,
  ...
  \`
}`,...(Y=(J=E.parameters)==null?void 0:J.docs)==null?void 0:Y.source}}};var Z,K,X;$.parameters={...$.parameters,docs:{...(Z=$.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  ...meta,
  ...
  \`
}`,...(X=(K=$.parameters)==null?void 0:K.docs)==null?void 0:X.source}}};var ee,te,ie;I.parameters={...I.parameters,docs:{...(ee=I.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  ...meta,
  ...
  \`
}`,...(ie=(te=I.parameters)==null?void 0:te.docs)==null?void 0:ie.source}}};var ne,ae,oe;S.parameters={...S.parameters,docs:{...(ne=S.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  ...meta,
  parameters: {
    docs: {
      description: {
...
\`
  ...
  \`
}`,...(le=(se=V.parameters)==null?void 0:se.docs)==null?void 0:le.source}}};var de,pe,ce;M.parameters={...M.parameters,docs:{...(de=M.parameters)==null?void 0:de.docs,source:{originalSource:`{
  ...meta,
  parameters: {
    docs: {
      description: {
...
<br/><br/><h4>Readonly normalizzato</h4>Se per qualche motivo vuoi avere gli elementi input readonly nella forma stilizzata come testo, aggiungi l'attributo \\\`plaintext\\\` a \\\`<it-input>\\\`.\`
  ...
  \`
}`,...(ce=(pe=M.parameters)==null?void 0:pe.docs)==null?void 0:ce.source}}};var me,ue,he;q.parameters={...q.parameters,docs:{...(me=q.parameters)==null?void 0:me.docs,source:{originalSource:`{
  ...meta,
  parameters: {
    docs: {
      description: {
...
\`
  ...
  \`
}`,...(he=(ue=q.parameters)==null?void 0:ue.docs)==null?void 0:he.source}}};var ge,ve,fe;T.parameters={...T.parameters,docs:{...(ge=T.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  ...meta,
  name: 'Area di testo',
  parameters: {
    docs: {
...
\\\`\\\`\\\`
  ...
  \`
}`,...(Ce=(we=A.parameters)==null?void 0:we.docs)==null?void 0:Ce.source}}};var Ee,$e,Ie;L.parameters={...L.parameters,docs:{...(Ee=L.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  ...StoryFormControlMethodAndProps({}),
  tags: ['!dev']
}`,...(Ie=($e=L.parameters)==null?void 0:$e.docs)==null?void 0:Ie.source}}};var Se,Ve,Me;F.parameters={...F.parameters,docs:{...(Se=F.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  name: 'i18n',
  tags: ['!dev'],
...
}`,...(Me=(Ve=F.parameters)==null?void 0:Ve.docs)==null?void 0:Me.source}}};const dt=["EsempioInterattivo","Placeholder","TestoDiSupporto","LabelHidden","IconeOPulsanti","Dimensioni","Disabilitato","Readonly","Password","Textarea","GestioneErrori","GestioneEventi","MetodiEPropPubblici","I18n"];export{S as Dimensioni,V as Disabilitato,w as EsempioInterattivo,P as GestioneErrori,A as GestioneEventi,F as I18n,I as IconeOPulsanti,$ as LabelHidden,L as MetodiEPropPubblici,q as Password,C as Placeholder,M as Readonly,E as TestoDiSupporto,T as Textarea,dt as __namedExportsOrder,h as default};
