import{x as n,o as a}from"./iframe-DBFznLP-.js";import{S as de}from"./formControlReusableStories-CUtehbfd.js";import"./form-control-LAed4GRx.js";import{I as pe,a as me}from"./types-krleEmxp.js";var h=Object.freeze,ce=Object.defineProperty,ue=(e,ve)=>h(ce(e,"raw",{value:h(e.slice())})),f;const t=e=>n`<it-input
    id="${a(e.id||void 0)}"
...
`}}}},o={...i,name:"Esempio interattivo",tags:["!autodocs","!dev"],parameters:{docs:{canvas:{sourceState:"closed"}}},render:e=>n`${t({...e,type:"text",label:"Campo di testo",name:"testo",id:"exampleInputText"})}
    ...
    ${t({...e,type:"time",label:"Campo orario",name:"orario",id:"exampleInputTime"})}`},r={...i,name:"Testo segnaposto",args:{type:"text",placeholder:"Testo segnaposto",label:"Etichetta",name:"placeholder-example",id:"placeholder-example"},render:e=>n`
    ${t({...e})}
  ...
  \`
}`,...(E=(q=l.parameters)==null?void 0:q.docs)==null?void 0:E.source}}};var P,w,M;s.parameters={...s.parameters,docs:{...(P=s.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...meta,
  ...
  \`
}`,...(M=(w=s.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var D,L,_;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...meta,
