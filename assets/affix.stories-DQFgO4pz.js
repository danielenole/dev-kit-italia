import{x as m}from"./iframe-D3QJi_qI.js";const a={title:"Componenti/Affix",tags:["documentation","new"]},i={...a,name:"Affix top",parameters:{docs:{description:{story:`
...
`}}},render:()=>m` <h4 class="h6">Esempio 1:</h4>
...
<div class="mt-5" style="font-size:0.9rem">Scorri il contenuto dell'esempio qui sotto per vedere l'effetto dell'affix.</div>`}}},render:()=>m`<h4 class="h6">Esempio 1:</h4>
      <div class="affix-example container border bg-white mb-4">
        <p>
          Mauris placerat commodo tincidunt. Mauris finibus hendrerit molestie. Vestibulum gravida, lectus sed semper
          fringilla, libero felis vehicula quam, at efficitur nisl justo mattis orci. Interdum et malesuada fames ac
      ...
      </div>`};var u,s,t;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...meta,
  name: 'Affix top',
  parameters: {
    docs: {
...
}`,...(t=(s=i.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};var l,r,n;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`{
  ...meta,
  name: 'Affix bottom',
  parameters: {
    docs: {
...
}`,...(n=(r=e.parameters)==null?void 0:r.docs)==null?void 0:n.source}}};const o=["AffixTop","AffixBottom"],p=Object.freeze(Object.defineProperty({__proto__:null,AffixBottom:e,AffixTop:i,__namedExportsOrder:o,default:a},Symbol.toStringTag,{value:"Module"}));export{p as A,i as a,e as b};
