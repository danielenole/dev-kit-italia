import{x as i,o as l}from"./iframe-C4eBJZ64.js";import"./preload-helper-Dp1pzeXC.js";const G=["lg","sm","xs"],M=["primary","secondary","success","danger","warning","link"],t=(e,n="")=>{var s;const a=((s=e.slot)==null?void 0:s.length)>0?e.slot:n;return i`
    <it-button
      variant="${l(e.variant)}"
      ?outline="${e.outline}"
      size="${l(e.size)}"
      ?block="${e.block}"
      ?disabled="${l(e.disabled?"true":void 0)}"
      ?icon="${e.icon}"
      type="${l(e.type)}"
    >
      ${a}
...
\`
  ...
  \`
}`,...(D=(L=u.parameters)==null?void 0:L.docs)==null?void 0:D.source}}};var A,w,N;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...meta,
  // name: 'Tipologie',
  args: {
    variant: 'primary'
  ...
  \`
}`,...(N=(w=p.parameters)==null?void 0:w.docs)==null?void 0:N.source}}};var B,E,I;b.parameters={...b.parameters,docs:{...(B=b.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'Sfondo scuro',
  args: {
    slot: ''
  },
...
visibile), o siano incluse attraverso mezzi alternativi, come testo aggiuntivo nascosto con la classe <code>.visually-hidden</code>.</p></div></div>\`
  ...
  \`
}`,...(I=(E=b.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};var q,Q,R;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...meta,
  name: 'Con icona',
  args: {},
  argTypes: {
...
}`,...(R=(Q=m.parameters)==null?void 0:Q.docs)==null?void 0:R.source}}};var U,_,O;v.parameters={...v.parameters,docs:{...(U=v.parameters)==null?void 0:U.docs,source:{originalSource:`{
  ...meta,
