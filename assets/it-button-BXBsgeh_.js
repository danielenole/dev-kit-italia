import{j as e,M as d,C as n,a as p,D as s}from"./blocks-h1mboQUh.js";import{useMDXComponents as c}from"./index-BCeUT687.js";import{S as u,E as t,V as h,a as x,D as j,T as m,b as a,C as l,c as b}from"./it-button.stories-ClF8LdwN.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-BW6CBm3q.js";function r(o){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",ul:"ul",...c(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:u}),`
...
`,e.jsx(n,{of:t}),`
`,e.jsx("div",{class:"small",children:"Questi sono gli attributi che definiscono l’aspetto, il comportamento e il contenuto del componente. Puoi modificare questi valori per personalizzare il componente. L’anteprima e il codice si aggiornano in tempo reale, così puoi vedere subito il risultato delle tue modifiche."}),`
`,e.jsx(p,{of:t}),`
...
`,e.jsxs(i.p,{children:["Per la personalizzazione degli stili puoi usare il selettore ",e.jsx(i.code,{children:"::part"})," passando il valore ",e.jsx(i.code,{children:"button"}),". ",e.jsx(i.a,{href:"/docs/personalizzazione-degli-stili--documentazione#selettore-part",children:"Vedi qui la guida dettagliata"}),"."]}),`
...
`,e.jsx(n,{of:b})]})}function D(o={}){const{wrapper:i}={...c(),...o.components};return i?e.jsx(i,{...o,children:e.jsx(r,{...o})}):r(o)}export{D as default};
