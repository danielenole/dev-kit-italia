...
.icon-white {
  fill: #fff !important;
}`;let d=class extends P{constructor(){super(...arguments),this.align="middle",this.label="",this.padded=!1}async updated(i){if(i.has("name")&&this.name){const e=H(this.name);if(e){const r=(await e()).default;this.parseAndStoreSvg(r)}}i.has("src")&&this.src&&await this.loadSvgFromUrl(this.src),i.has("label")&&this.handleTitleId(),(i.has("label")||i.has("size")||i.has("color")||i.has("padded")||i.has("role")||i.has("align"))&&this.updateSvgAttributes()}handleTitleId(){this.label?this.titleId||(this.titleId=`icon-label-${crypto.randomUUID()}`):this.titleId=void 0}async loadSvgFromUrl(i){try{const e=await fetch(i);if(!e.ok)throw new Error(`Failed to load SVG from ${i} (status: ${e.status})`);const r=await e.text();this.parseAndStoreSvg(r)}catch{this.svgElement=void 0,this.announceSvgLoadError()}}announceSvgLoadError(){this.dispatchEvent(new Event("error",{bubbles:!1,composed:!1,cancelable:!1}))}parseAndStoreSvg(i){const o=new DOMParser().parseFromString(i,"image/svg+xml").documentElement;this.svgElement=o,this.updateSvgAttributes()}applySvgAttributes(i){i.removeAttribute("width"),i.removeAttribute("height");const e=this.updateClasses();if(i.setAttribute("class",e),i.setAttribute("part","icon"),this.label){if(i.removeAttribute("aria-hidden"),i.setAttribute("role","img"),i.removeAttribute("aria-labelledby"),i.querySelectorAll("title").forEach(r=>r.remove()),this.titleId){const r=document.createElementNS("http://www.w3.org/2000/svg","title");r.id=this.titleId,r.textContent=this.label,i.prepend(r),i.setAttribute("aria-labelledby",this.titleId)}}else i.setAttribute("aria-hidden","true"),i.setAttribute("role","presentation"),i.removeAttribute("aria-labelledby"),i.querySelectorAll("title").forEach(r=>r.remove())}updateSvgAttributes(){this.svgElement&&this.applySvgAttributes(this.svgElement)}updateClasses(){return["icon",this.size?`icon-${this.size}`:"",this.color?`icon-${this.color}`:"",this.align?`align-${this.align}`:"",this.padded?"icon-padded":""].filter(Boolean).join(" ").trim()}handleSlotChange(){const e=this.slotEl.assignedNodes({flatten:!0}).find(r=>r.nodeType===Node.ELEMENT_NODE&&r.tagName.toLowerCase()==="svg");e&&this.applySvgAttributes(e)}render(){return x`
      <slot @slotchange=${this.handleSlotChange}>${this.svgElement?S`${this.svgElement}`:C}</slot>
    `}};d.styles=G;n([l({type:String,reflect:!0}),m("design:type",Object)],d.prototype,"size",void 0);n([l({type:String}),m("design:type",String)],d.prototype,"name",void 0);n([l({type:String,reflect:!0}),m("design:type",String)],d.prototype,"color",void 0);n([l({type:String,reflect:!0}),m("design:type",String)],d.prototype,"align",void 0);n([l({type:String,reflect:!0}),m("design:type",Object)],d.prototype,"label",void 0);n([l({type:Boolean,reflect:!0}),m("design:type",Object)],d.prototype,"padded",void 0);n([l({type:String,reflect:!0}),m("design:type",String)],d.prototype,"src",void 0);n([V(),m("design:type",HTMLElement)],d.prototype,"svgElement",void 0);n([L("slot"),m("design:type",HTMLSlotElement)],d.prototype,"slotEl",void 0);d=n([F("it-icon")],d);
