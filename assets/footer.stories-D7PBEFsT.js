import{x as s}from"./iframe-BW6CBm3q.js";const v=s`
...
</footer>`,f={title:"Componenti/Footer",component:"footer",tags:["documentation"]},i={tags:["!autodocs","!dev"],parameters:{canvas:{hidden:!0,sourceState:"none"},viewMode:"docs",docs:{page:null}}},e={render:()=>s`${v}`,name:"Footer completo",parameters:{docs:{description:{story:`Nel footer completo sono presenti i seguenti elementi:
...
- **Iscrizione Newsletter** (opzionale).`}}}},l={render:()=>s`${h}`,name:"Footer compatto",parameters:{docs:{description:{story:`Il footer compatto è una versione semplificata del footer completo.
...
`}}}};var a,t,o;i.parameters={...i.parameters,docs:{...(a=i.parameters)==null?void 0:a.docs,source:{originalSource:`{
  tags: ['!autodocs', '!dev'],
  parameters: {
    canvas: {
      hidden: true,
...
}`,...(o=(t=i.parameters)==null?void 0:t.docs)==null?void 0:o.source}}};var n,c,r;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
...
}`,...(p=(m=l.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};const u=["Placeholder","FooterCompleto","FooterCompatto"],z=Object.freeze(Object.defineProperty({__proto__:null,FooterCompatto:l,FooterCompleto:e,Placeholder:i,__namedExportsOrder:u,default:f},Symbol.toStringTag,{value:"Module"}));export{z as F,e as a,l as b};
