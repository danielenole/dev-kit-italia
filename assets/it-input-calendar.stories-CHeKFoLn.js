import{x as s,o as t}from"./iframe-DTWXh8gn.js";import{I as S}from"./types-CucKb5le.js";const o=new Date,M=o.toISOString().split("T")[0],x=new Date(o);x.setDate(o.getDate()+3);const $=x.toISOString().split("T")[0],D=o.getDay(),I=(8-D)%7||7,f=new Date(o);f.setDate(o.getDate()+I);const h=f.toISOString().split("T")[0],l=e=>s`<it-input
    id="${t(e.id||void 0)}"
    type="date"
