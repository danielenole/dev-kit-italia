import{x as t}from"./iframe-CXDqws0b.js";import"./it-icon-CLY6zOjc.js";import"./it-button-GG-ZkDmX.js";import"./it-input-C1OoXnSs.js";import"./preload-helper-Dp1pzeXC.js";import"./query-Bgk1JvUp.js";import"./directive-CvdRHFdJ.js";import"./query-assigned-elements-kOdE9H1L.js";import"./when-BR7zwNJC.js";const h=t`
...
**In caso non si stia utilizzando il bundle unico, assicurarsi di avere importato tutti i fogli di stile necessari da \`bootstrap-italia\`.**
        `.trim()}}}},i={tags:["!autodocs","!dev"],parameters:{canvas:{hidden:!0,sourceState:"none"},viewMode:"docs",docs:{page:null}}},e={render:()=>t`${h}`,name:"Footer completo",parameters:{docs:{description:{story:`Nel footer completo sono presenti i seguenti elementi:
...
- **Iscrizione Newsletter** (opzionale).`}}}},l={render:()=>t`${f}`,name:"Footer compatto",parameters:{docs:{description:{story:`Il footer compatto è una versione semplificata del footer completo.
