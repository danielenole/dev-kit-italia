import{o as i,E as s,x as a}from"./iframe-D3QJi_qI.js";const le=["xs","sm","md","lg","xl","xxl"],pe=["primary","secondary"],ce=["image","text","icon"],de=["active","busy","hidden"],me=["approved","declined","notify"],e=t=>a`
  <it-avatar
    type="${i(t.type||s)}"
    size="${i(t.size||s)}"
