import{x as i}from"./iframe-BiclfI91.js";import{o as l}from"./if-defined-tWK9HKZq.js";import"./it-button-7O2qlVVR.js";import"./it-icon-CSHPhcQf.js";import"./preload-helper-Dp1pzeXC.js";import"./directive-CvdRHFdJ.js";import"./query-Bd2ew8Gc.js";const G=["lg","sm","xs"],M=["primary","secondary","success","danger","warning","link"],t=(e,n="")=>{var s;const a=((s=e.slot)==null?void 0:s.length)>0?e.slot:n;return i`
    <it-button
      variant="${l(e.variant)}"
      ?outline="${e.outline}"
      size="${l(e.size)}"
