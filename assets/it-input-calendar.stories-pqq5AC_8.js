import{b as s,o as t}from"./iframe-DLjZ3WDc.js";import{I as p}from"./types-CucKb5le.js";const o=new Date,m=o.toISOString().split("T")[0],d=new Date(o);d.setDate(o.getDate()+3);const u=d.toISOString().split("T")[0],v=o.getDay(),g=(8-v)%7||7,c=new Date(o);c.setDate(o.getDate()+g);const y=c.toISOString().split("T")[0],l=e=>s`<it-input
    id="${t(e.id||void 0)}"
    type="date"
