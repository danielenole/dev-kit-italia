import{x as i,o as l}from"./iframe-DTYTDCWB.js";import"./preload-helper-Dp1pzeXC.js";const G=["lg","sm","xs"],M=["primary","secondary","success","danger","warning","link"],t=(e,n="")=>{var s;const a=((s=e.slot)==null?void 0:s.length)>0?e.slot:n;return i`
    <it-button
      variant="${l(e.variant)}"
      ?outline="${e.outline}"
      size="${l(e.size)}"
