import{x as r}from"./iframe-CPkArXh1.js";const a={title:"Componenti/Badge",tags:["documentation","new"]},e={...a,parameters:{docs:{description:{story:"La dimensione e il carattere di ogni badge si adattano automaticamente a quelli dell’elemento che lo contiene."}}},render:()=>r`
...
`}}},render:()=>r`
  ...
  `};var d,t,l;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  ...meta,
  parameters: {
    docs: {
      description: {
  ...
  render: () => html\`
    ...
    <div class="h6">Titolo di esempio h6<span class="badge badge-secondary">New</span></div>
  \`
}`,...(l=(t=e.parameters)==null?void 0:t.docs)==null?void 0:l.source}}};var c,g,p;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  ...meta,
  name: 'Bottoni e link',
  parameters: {
    docs: {
...
\`
  ...
  \`
}`,...(p=(g=s.parameters)==null?void 0:g.docs)==null?void 0:p.source}}};var b,u,m;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`{
  ...meta,
...
\`
  ...
  render: () => html\`
    ...
    <span class="badge badge-warning">Warning</span>
  \`
}`,...(m=(u=n.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var v,h,y;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...meta,
...
\`
  ...
  render: () => html\`
    ...
    <span class="badge rounded-pill badge-warning">Warning</span>
  \`
}`,...(y=(h=i.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};var f,z,S;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...meta,
  parameters: {
    docs: {
      description: {
...
\`
  ...
  render: () => html\`
    ...
    <a href="#" class="badge badge-warning">Warning</a>
  \`
}`,...(S=(z=o.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};const w=["Dimensione","BottoniELink","VariazioniColore","Arrotondato","Link"],N=Object.freeze(Object.defineProperty({__proto__:null,Arrotondato:i,BottoniELink:s,Dimensione:e,Link:o,VariazioniColore:n,__namedExportsOrder:w,default:a},Symbol.toStringTag,{value:"Module"}));export{i as A,s as B,e as D,o as L,N as S,n as V};
