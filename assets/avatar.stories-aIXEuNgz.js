import{o as i,E as s,x as a}from"./iframe-DBFznLP-.js";import"./preload-helper-Dp1pzeXC.js";const oe=["xs","sm","md","lg","xl","xxl"],le=["primary","secondary"],pe=["image","text","icon"],ce=["active","busy","hidden"],de=["approved","declined","notify"],e=t=>a`
  <it-avatar
    type="${i(t.type||s)}"
    size="${i(t.size||s)}"
