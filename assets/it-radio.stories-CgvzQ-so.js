...
`}}},render:()=>o`<div class="hide-preview"></div>`},l={...a,name:"Utilizzo",tags:["!dev"],parameters:{viewMode:"docs",docs:{canvas:{hidden:!0,sourceState:"none"},description:{story:"\nIl componente `<it-radio>` deve essere sempre utilizzato all'interno di un `<it-radio-group>` e richiede obbligatoriamente:\n\n- Un **attributo `value`** univoco per identificare l'opzione\n- Una **label definita tramite slot** `<span slot=\"label\">Testo della label</span>`\n\n#### Proprietà principali\n\n| Proprietà | Tipo | Descrizione |\n|-----------|------|-------------|\n| `value` | `string` | Valore univoco del radio button (obbligatorio) |\n| `disabled` | `boolean` | Se `true`, disabilita il singolo radio button |\n| `support-text` | `string` | Testo di supporto visualizzato sotto la label (obbligatorio) |\n"}}},render:()=>o`<div class="hide-preview"></div>`},s={...a,name:"Definizione della Label",parameters:{docs:{description:{story:"\n\nSia `<it-radio-group>` che `<it-radio>` espongono uno slot `label` per definire le rispettive etichette.\n\nLa label del gruppo `<it-radio-group>` viene definita tramite lo slot `label` dell'elemento `<it-radio-group>` e identifica l'intero gruppo di radio button. È possibile utilizzare HTML all'interno dello slot per creare label formattate.\n\nOgni `<it-radio>` richiede obbligatoriamente una label definita tramite il proprio slot `label`. La label identifica la singola opzione all'interno del gruppo. È possibile utilizzare anche HTML all'interno dello slot per creare label più complesse con formattazione o altri elementi.\n"}}},render:e=>o`
  ...
  `},u={...a,name:"Radio disabilitati",parameters:{docs:{description:{story:`
...
`}}},render:()=>o`
  ...
  \`
}`,...(z=(v=t.parameters)==null?void 0:v.docs)==null?void 0:z.source}}};var f,h,$;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
...
}`,...($=(h=r.parameters)==null?void 0:h.docs)==null?void 0:$.source}}};var y,R,S;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...meta,
  name: 'Utilizzo',
  tags: ['!dev'],
  parameters: {
...
\`
  ...
  render: () => html\`<div class="hide-preview"></div>\`
}`,...(S=(R=l.parameters)==null?void 0:R.docs)==null?void 0:S.source}}};var I,w,q;s.parameters={...s.parameters,docs:{...(I=s.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...meta,
...
\`
  ...
  \`
}`,...(q=(w=s.parameters)==null?void 0:w.docs)==null?void 0:q.source}}};var x,P,L;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...meta,
  ...
  \`
}`,...(L=(P=d.parameters)==null?void 0:P.docs)==null?void 0:L.source}}};var T,C,E;p.parameters={...p.parameters,docs:{...(T=p.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...meta,
  parameters: {
    docs: {
      description: {
  ...
  \`
}`,...(E=(C=p.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var M,D,V;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
  ...meta,
...
\`
  ...
  \`
}`,...(V=(D=u.parameters)==null?void 0:D.docs)==null?void 0:V.source}}};var O,A,k;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...meta,
