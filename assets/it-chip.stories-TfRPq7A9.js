...
`,_t=s=>{const{avatar:t,avatarAlt:e,withIcon:i,label:a,size:o,variant:c,withDismissButton:m,dismissable:y,isDisabled:z,href:Et,id:xt,a11yDescription:Ct}=s;return d`
    <it-chip
      label="${a??""}"
      size="${o??"sm"}"
      variant="${c??""}"
      ...
      a11y-description="${Ct}"
      ?id="${xt}"
      >${i?Bt(c,o):F}${y&&m?qt("I am dismissable",z):F}</it-chip
    >
...
\`
  ...
  \`
}`,...(ut=(mt=I.parameters)==null?void 0:mt.docs)==null?void 0:ut.source}}};const Yt=["EsempioInterattivo","PersonalizzazioneDegliStili","VarianteConLink","VariantiColore","VariantiColoreLink","VariantiDimensione","ChipConChiusura","ChipDisabilitata","ChipConAvatar","ChipConIcona"];export{D as ChipConAvatar,$ as ChipConChiusura,I as ChipConIcona,A as ChipDisabilitata,E as EsempioInterattivo,x as PersonalizzazioneDegliStili,C as VarianteConLink,V as VariantiColore,k as VariantiColoreLink,S as VariantiDimensione,Yt as __namedExportsOrder,jt as default};
